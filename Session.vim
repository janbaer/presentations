...
nnoremap <NL> ddp " Move line down
onoremap <NL> ddp " Move line down
vmap  <Plug>SchleppUp
nnoremap  ddkP " Move line up"
onoremap  ddkP " Move line up"
...
set undolevels=700
set updatetime=2000
set wildignore=*.pyc,*_build/*,*/coverage/*,.DS_Store,.git,.vscode,.idea,obj,tags
set wildmenu
...
set shortmess=aoO
badd +12 cssgrid/index.html
badd +18 index.html
badd +12 serviceworker/index.html
badd +0 serviceworker/serviceworker.md
argglobal
silent! argdel *
edit serviceworker/serviceworker.md
...
setlocal nowrap
setlocal wrapmargin=0
let s:l = 45 - ((41 * winheight(0) + 25) / 51)
